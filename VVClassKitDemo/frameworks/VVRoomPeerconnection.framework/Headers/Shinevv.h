...
/**
 ...
 @param peersDict 成员信息
 */
- (void)onPeerRoleChanged:(NSDictionary *)peersDict;
...
/**
 ...
 @param status 自身新状态
 */
- (void)onPeerStatusChanged:(bool)status;
...
/**
 ...
 @param page 跳转第几页
 */
- (void)onRecPPTMessagePPT:(NSString *)ppt Page:(NSInteger)page;
@end
...
/**
 ...
 @param roomId 房间号
 @param role 身份
 @param mediaType 媒体类型（音频:audio、视频:video）默认为video
...
/**
 ...
 @param boolmes 开启音视频、关闭音视频
 */
- (void)sendReqRoleChangeRequest:(bool)boolmes;
...
/**
 删除存储的服务端历史记录
 */
- (void)clearServerDrawBoardID:(NSString *)boradID;
...
/**
 用户拥有权限后发送PPT课件同步消息
 */
- (void)sendBroadPPTMes:(NSDictionary *)PPTMes;
/**
 用户拥有权限后发送白板同步消息
 */
- (void)sendBroadDrawBoardIndexMes:(NSDictionary *)DrawBoardMes;
/**
 用户拥有权限后发送白板数量变化消息
 */
- (void)sendBroadDrawBoardPagesMes:(NSDictionary *)DrawBoardMes;
/**
 用户拥有权限后发送白板横竖屏变化消息
 */
- (void)sendBroadDrawBoardOriMes:(NSDictionary *)DrawBoardMes;

/**
 用户拥有权限后发送视频课件同步消息
 */
- (void)sendBroadVideoMes:(NSDictionary *)videoMes;

/**
 用户拥有权限后发送路由同步消息
 */
- (void)sendBroadRouteMes:(NSDictionary *)RouteMes;
