...
const char kScreenLabel[] = "screen_label";
...
public:
	...
	virtual rtc::scoped_refptr<webrtc::VideoTrackInterface> GetScreenShareTrack() = 0;
...
public:
	...
	virtual rtc::scoped_refptr<webrtc::VideoTrackInterface> GetScreenShareTrack() override;
...
public:
	...
	virtual rtc::scoped_refptr<webrtc::VideoTrackInterface> GetScreenShareTrack() override { return NULL; }
...
private:
	...
	void CreateOffer();
	std::vector<std::string> Split(std::string strtem, std::string a);
