...
public:
	...
	webrtc::MediaStreamTrackInterface* GetTrack(std::string direction, std::string source);

	bool Join(std::string displayName, std::string peerName, std::string role, std::string device, std::string extraInfoFromServer, std::string userObject);
	...
	bool JoinProcess(Json::Value peers, std::string extranInfoFromServer);
