...
public:
	...
	virtual void FillRtpParametersForTrack(Json::Value& rtpParameters, std::string kind, std::string label, resip::SdpContents local_sdp) = 0;
protected:
...
public:
	...
	virtual void FillRtpParametersForTrack(Json::Value& rtpParameters, std::string kind, std::string label, resip::SdpContents local_sdp) override;
};
